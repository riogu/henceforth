...
mod tests {
    ...
    #[test]
    fn test_simple_main() {
        let ast = analyze_file("tests/compile_tests/simple_main.hfs");
    ...
    fn test_function_with_lots_of_arguments() {
        let ast = analyze_file("tests/compile_tests/function_with_lots_of_arguments.hfs");
    ...
    fn test_function_with_no_arguments() {
        let ast = analyze_file("tests/compile_tests/function_with_no_arguments.hfs");
        let expected = StackAnalyzerBuilder::new()
    ...
    fn test_function_with_no_return_type() {
        let ast = analyze_file("tests/compile_tests/function_with_no_return_type.hfs");
        let expected = StackAnalyzerBuilder::new()
    ...
    fn test_variable_declarations() {
        let ast = analyze_file("tests/compile_tests/variable_declarations.hfs");
    ...
    fn test_copy_and_move() {
        let ast = analyze_file("tests/compile_tests/copy_and_move.hfs");
        let expected = StackAnalyzerBuilder::new()
            .func_with("main", None, None)
            .body()
    ...
    #[test]
    fn test_operations() {
        let ast = analyze_file("tests/compile_tests/operations.hfs");
        let expected = StackAnalyzerBuilder::new()
            .func_with("main", None, None)
            .body()
            .stack_block()
    ...
    #[test]
    fn test_while_loop() {
        let ast = analyze_file("tests/compile_tests/while_loop.hfs");
        let expected = StackAnalyzerBuilder::new()
            .func_with("main", None, None)
            .body()
            .variable("a", Type::new_int(0))
    ...
    fn test_simple_if_else() {
        let ast = analyze_file("tests/compile_tests/simple_if_else.hfs");
        let expected = StackAnalyzerBuilder::new()
            .func_with("main", None, None)
            .body()
            .if_statement()
    ...
    fn test_if_elif_else() {
        let ast = analyze_file("tests/compile_tests/if_elif_else.hfs");
        let expected = StackAnalyzerBuilder::new()
    ...
    fn test_copy_and_move_func_calls() {
        let ast = analyze_file("tests/compile_tests/copy_and_move_func_calls.hfs");
        let expected = StackAnalyzerBuilder::new()
