...
impl CfgPrintable for CfgFunction {
    fn get_repr(&self, arena: &IrArena) -> String {
        ...
        format!("fn {}: ({}) -> ({}) {{\n{}\n}}", self.name, params.get_repr(arena), returns.get_repr(arena), blocks_repr)
    }
}
...
impl CfgPrintable for CfgOperation {
    fn get_repr(&self, arena: &IrArena) -> String {
        match self {
            CfgOperation::Add(a, b) => format!("{} + {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Sub(a, b) => format!("{} - {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Mul(a, b) => format!("{} * {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Div(a, b) => format!("{} / {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Mod(a, b) => format!("{} % {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Equal(a, b) => format!("{} == {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::NotEqual(a, b) => format!("{} != {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Less(a, b) => format!("{} < {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::LessEqual(a, b) => format!("{} <= {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Greater(a, b) => format!("{} > {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::GreaterEqual(a, b) => format!("{} >= {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Or(a, b) => format!("{} || {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::And(a, b) => format!("{} && {}", arena.inst_name(*a), arena.inst_name(*b)),
            CfgOperation::Not(a) => format!("!{}", arena.inst_name(*a)),
        }
    }
}
...
impl CfgPrintable for TerminatorInst {
    fn get_repr(&self, arena: &IrArena) -> String {
        match self {
            TerminatorInst::Return(_, inst_id) => format!("return {}", arena.inst_name(*inst_id)),
            ...
            TerminatorInst::Jump(_, block_id) => format!("jump {}", arena.get_block(*block_id).name),
    ...
    fn get_repr(&self, arena: &IrArena) -> String {
        match self {
            Instruction::Parameter { source_info, index, type_id } =>
                format!("{} %arg{}", arena.get_type(*type_id).get_repr(arena), index),
