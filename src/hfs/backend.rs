...
pub fn run(kind: BackendKind, mut arena: IrArena, top_level_insts: Vec<IrTopLevelId>, scope_stack: ScopeStack, output: Option<PathBuf>) -> i32 {
    match kind {
        ...
        BackendKind::Cranelift => {
            ...
            match cranelift_object_backend::compile_and_link(&mut arena, &output) {
                Ok(code) => code,
                Err(e) => {
